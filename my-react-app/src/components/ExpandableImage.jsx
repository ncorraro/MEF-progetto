...
import miss from "../image/missioneNuovoGrosso.png";
import missMin from "../image/missNuovo.png";
...
const ExpandableImage = () => {
  ...
  return (
    <div className="flex justify-center items-center flex-col w-full">
      <div 
        className="relative cursor-pointer w-full border-2  rounded-lg mt-2  rounded-3 p-3 "
        ...
        {expanded ? (
          ...
          <div className={`fade ${expanded ? 'show' : ''}`} style={{ transition: 'opacity .50s linear', opacity: expanded ? 1 : 0, display: expanded ? 'block' : 'none'}}>
            ...
            <div className="d-flex justify-content-center align-items-center mb-3">
              <Link to={`/uffici`} className="btn col4 text-white align-self-start mt-3">
          ...
          <div className="relative w-full">
            ...
            <div className="absolute bottom-4 left-0 right-0 text-center coltext1 font-bold">
